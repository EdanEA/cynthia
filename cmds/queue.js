...
async function getTrack(id) {
  return fetch(`http://${conf.lavalink.host}:${conf.lavalink.port}/loadtracks?identifier=${id}`, { headers: { Authorization: conf.lavalink.pass } })
    .then(res => res.json())
