...
exports.run = async function(message, args) {
  ...
  if(!f.hasMod(message.member, message.channel.guild) && !g.music.anySkip && g.queue[0].requester !== message.author.id)
